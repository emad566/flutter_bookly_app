...
class ServerFailure extends Failure {
  ...
  factory ServerFailure.fromResponse(int? statusCode, dynamic response){
    ...
    if(statusCode ==  404){
      return ServerFailure('$statusCode: The request is not found. . Please try again later');
    }

    if(statusCode ==  500){
      return ServerFailure('$statusCode: Internal server error. Please try again later');
    }

    return ServerFailure('$statusCode: Failure with unknown server respond error!');
  }
}
