...
abstract  class AppColors{
  ...
  static const Color tripleBg = Color(0xFFDDDDDD);
  static const Color star = Colors.yellowAccent;

  //DarkMode Mode
  static const Color darkPrimaryText = Colors.white;
  static const Color darkSecondaryText = Color(0xFFDDDDDD);
  static const Color darkTripleText = Color(0xFFCCCCCC);
  static const Color darkPrimaryBg = Color(0xFF100b20);
  static const Color darkSecondaryBg = Colors.white54;
  static const Color darkTripleBg = Color(0xFF666666);
